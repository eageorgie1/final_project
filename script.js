...
const cities = [
  ...
  { name: "Plovdiv", longitude: 24.7453, latitude: 42.1354, zoom: 16 },
  { name: "Varna", longitude: 27.9147, latitude: 43.2141, zoom: 16 },
  { name: "Burgas", longitude: 27.4678, latitude: 42.5048, zoom: 17 },
  { name: "Ruse", longitude: 25.9547, latitude: 43.8356, zoom: 15 }
];
